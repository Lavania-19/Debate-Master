...
__all__ = [
    ...
    'DISPID_SVAudioOutput', 'SECFIgnoreCase', 'SAFT22kHz8BitStereo',
    'eLEXTYPE_RESERVED10', 'DISPID_SGRSTransitions', 'SREStreamEnd',
    'SDTRule', 'SAFT8kHz16BitStereo', 'DISPID_SPPEngineConfidence',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpeechRecoContext',
    'SAFTADPCM_44kHzStereo', 'DISPID_SVAudioOutputStream',
    'DISPID_SRCAudioInInterferenceStatus', 'SVEStartInputStream',
    'SPPS_Unknown', 'SP_VISEME_6', 'SpeechCategoryVoices',
    'SPEI_MIN_TTS', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRCEPropertyNumberChange', 'SPSInterjection',
    'DISPID_SPEsItem', 'SPSLMA', 'SP_VISEME_15', 'SPDATAKEYLOCATION',
    'DISPID_SRIsShared', 'SpObjectTokenCategory',
    'ISpeechObjectTokenCategory', 'SPWF_INPUT', 'SPEI_WORD_BOUNDARY',
    'ISpRecoGrammar', 'SRTReSent', 'SPVOICESTATUS',
    'DISPID_SRAudioInput', 'ISpeechXMLRecoResult',
    'SECFEmulateResult', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRGetPropertyString', 'DISPID_SDKGetBinaryValue',
    'SPPS_RESERVED3', 'SPWORDPRONUNCIATIONLIST', 'SAFT48kHz16BitMono',
    'ISpStreamFormat', 'SpeechAudioState', 'SPSEMANTICFORMAT',
    'SBONone', 'SVP_5', 'DISPID_SVEStreamStart', 'SPEI_PHONEME',
    'ISpObjectTokenCategory', 'SPWF_SRENGINE', 'DISPID_SPRulesCount',
    'WAVEFORMATEX', 'SPEI_REQUEST_UI', 'SPPROPERTYINFO',
    'SPWT_PRONUNCIATION', 'DISPID_SPRFirstElement',
    'DISPID_SOTGetAttribute', 'SRTExtendableParse',
    'ISpeechObjectToken', 'SP_VISEME_3', 'SPEI_TTS_PRIVATE',
    'SRERequestUI', 'eLEXTYPE_USER', 'SPCT_SLEEP',
    'DISPID_SGRSTsCount', 'SAFT22kHz16BitMono', 'SPAS_PAUSE',
    'DISPID_SABIEventBias', 'DISPID_SPAsCount',
    'DISPID_SRRTTickCount', 'SPAR_Unknown', 'SVSFUnusedFlags',
    'SPAR_High', 'SpMMAudioIn', 'DISPID_SOTCGetDataKey',
    'SAFTGSM610_44kHzMono', 'DISPID_SFSClose', 'SGDisplay',
    'DISPID_SRCRecognizer', 'DISPID_SPEActualConfidence',
    'SPSModifier', 'ISpRecognizer2', 'SAFTCCITT_ALaw_11kHzMono',
    ...
    'SAFTExtendedAudioFormat', 'SVP_17', 'SPRST_INACTIVE',
    'DISPID_SRGRecoContext', 'SPPS_Verb', 'DISPID_SWFEChannels',
    'SPFM_NUM_MODES', 'STCRemoteServer', 'SVSFIsNotXML',
    'DISPID_SPPConfidence', 'SAFT48kHz8BitStereo', 'SVSFVoiceMask',
    'DISPID_SMSALineId', 'SpLexicon', 'SGRSTTEpsilon',
    ...
    'DISPID_SLWs_NewEnum', 'SPEI_SR_BOOKMARK',
    'ISpPhoneticAlphabetConverter', 'ISpeechPhraseRule',
    'DISPID_SRGId', 'Speech_Max_Pron_Length', 'SPDKL_CurrentConfig',
    'SpeechEngineConfidence', 'SAFTCCITT_uLaw_22kHzMono',
    'ISequentialStream', 'DISPID_SVEAudioLevel', 'SPFM_CREATE',
    'SPRST_INACTIVE_WITH_PURGE', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVSLastBookmark', 'ISpeechAudioStatus',
    'ISpResourceManager', 'DISPID_SVVolume', 'ISpPhraseAlt',
    'SPDKL_LocalMachine', 'SAFT11kHz8BitStereo', 'eLEXTYPE_PRIVATE15',
    'DISPID_SGRsCount', 'ISpeechPhraseProperty', 'SPBINARYGRAMMAR',
    'DISPID_SOTRemoveStorageFileName', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SOTIsUISupported', 'DISPID_SpeechAudioFormat',
    ...
    'SPSHT_OTHER', 'SP_VISEME_7', 'DISPID_SRGetFormat',
    'SPLEXICONTYPE', 'SSTTWildcard',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SGRInitialState', 'SPPS_NotOverriden',
    'SPRECOCONTEXTSTATUS', 'SVPAlert', 'SITooLoud',
    'SPSEMANTICERRORINFO', 'SpeechCategoryAudioOut', 'SDTAlternates',
    'Speech_StreamPos_RealTime', 'SpeechPropertyResourceUsage',
    'SREAdaptation', 'SVP_15', 'SAFTADPCM_11kHzMono',
    'DISPID_SVSpeakStream', 'DISPID_SLWType', 'DISPID_SGRName',
    'SREPropertyStringChange', 'SAFTCCITT_ALaw_11kHzStereo',
    'eLEXTYPE_PRIVATE12', 'DISPID_SVEStreamEnd', 'SP_VISEME_9',
    'DISPID_SRCEPropertyStringChange', 'SpNotifyTranslator',
    'DISPID_SPRulesItem', 'DISPID_SGRSTType', 'DISPID_SVSVisemeId',
    'SpeechTokenValueCLSID', 'eWORDTYPE_ADDED',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SPRuleEngineConfidence', 'ISpRecognizer3',
    'IInternetSecurityManager',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SRGRules',
    'DISPID_SVSRunningState', 'SVP_21', 'SPEI_UNDEFINED',
    'SpeechVoicePriority', 'SRESoundEnd', 'SpeechPartOfSpeech',
    'SFTInput', 'DISPID_SMSGetData', 'SREAudioLevel',
    'SPCATEGORYTYPE', 'DISPID_SPRuleParent', 'DISPID_SDKEnumKeys',
    'tagSTATSTG', 'SVP_7', 'SWTDeleted', 'DISPID_SGRClear',
    'Speech_StreamPos_Asap', 'SPPS_Interjection', 'SPCONTEXTSTATE',
    'SAFT12kHz8BitStereo', 'SLTUser', 'ISpNotifySource',
    'SPINTERFERENCE_TOOQUIET', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPBO_AHEAD', 'DISPID_SpeechRecoContextEvents', 'SWTAdded',
    'ISpeechPhraseElements', 'DISPID_SRCEBookmark',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SRCEFalseRecognition',
    'SVSFPersistXML', 'SPPS_Modifier', 'DISPID_SRCEStartStream',
    'DISPID_SDKDeleteKey', 'DISPID_SOTCDefault', 'SPGRAMMARSTATE',
    'SAFT12kHz16BitStereo', 'DISPID_SPCIdToPhone',
    'DISPID_SVSInputWordPosition', 'SECLowConfidence', 'SVEPrivate',
    'SPAUDIOBUFFERINFO', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SOTDataKey', 'DISPID_SGRSTsItem', 'eLEXTYPE_PRIVATE13',
    'SpShortcut', 'ISpXMLRecoResult', 'SAFT11kHz16BitMono',
    'SAFTGSM610_11kHzMono', 'SVSFIsFilename', 'SPAUDIOSTATE',
    'SVP_19', 'SpeechRegistryUserRoot', 'DISPID_SRGCmdLoadFromMemory',
    'SpeechUserTraining', 'DISPID_SVEEnginePrivate',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPEAudioStreamOffset',
    'SPEI_MIN_SR', 'SREInterference', 'SP_VISEME_2', 'SpVoice',
    'SDA_Two_Trailing_Spaces', 'SSSPTRelativeToEnd', 'SPWORDLIST',
    'DISPID_SRRAudio', 'SpAudioFormat', 'SAFTGSM610_22kHzMono',
    'SPPS_RESERVED4', 'DISPID_SRSSupportedLanguages',
    'DISPID_SBSSeek', 'SVP_20', 'DISPID_SGRsAdd',
    'DISPID_SRCEInterference', 'ISpeechBaseStream', 'SRAImport',
    'DISPID_SRRAudioFormat', 'SpSharedRecoContext', 'SVP_13',
    'DISPID_SLPsCount', 'ISpeechRecoResult2',
    'DISPID_SVWaitUntilDone', 'SPSTREAMFORMATTYPE',
    'SpeechVisemeFeature', 'SPEI_MAX_TTS', 'SPEI_RECOGNITION',
    'DISPID_SRRTStreamTime', 'SpeechGrammarRuleStateTransitionType',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SLGetPronunciations',
    'SASClosed', 'SAFT11kHz16BitStereo', 'SPEI_START_INPUT_STREAM',
    'DISPID_SVIsUISupported', 'SPSNotOverriden',
    'SpeechRetainedAudioOptions', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechPhraseReplacements', 'DISPID_SRGCmdLoadFromFile',
    'SpeechEngineProperties', 'tagSPPROPERTYINFO',
    'DISPID_SPAStartElementInResult', 'SpeechAudioVolume', 'SPRULE',
    'SpeechTokenContext', 'SPBO_NONE', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'ISpEventSink',
    'SPRECORESULTTIMES', 'SRTStandard',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SFSOpen',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SpeechLexicon',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SASetState', 'DISPID_SAFGuid',
    'DISPID_SpeechVoiceEvent', 'SPEI_PROPERTY_STRING_CHANGE',
    'STSF_AppData', 'STCInprocHandler', 'SASPause',
    'eLEXTYPE_RESERVED7', 'DISPID_SRRecognizer',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFT48kHz16BitStereo', 'SSTTTextBuffer',
    'SpeechDiscardType', 'DISPID_SPEAudioSizeTime',
    'DISPID_SRDisplayUI', 'DISPID_SpeechObjectTokens',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVSInputWordLength',
    'SVP_4', 'ISpRecoCategory', 'SpWaveFormatEx',
    'DISPID_SGRSTs_NewEnum', 'ISpeechRecoResultDispatch',
    'DISPID_SRCCreateResultFromMemory', 'SECFIgnoreWidth',
    'SpeechRecoEvents', 'UINT_PTR', 'SP_VISEME_19', 'ISpMMSysAudio',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPRText', 'SPAR_Medium',
    'DISPID_SGRsItem', 'ISpeechPhraseAlternates',
    'SpeechDataKeyLocation', 'SAFT32kHz8BitMono',
    'DISPID_SPAPhraseInfo', 'SDTAudio', 'DISPID_SPERetainedSizeBytes',
    'SAFT11kHz8BitMono', 'ISpeechCustomStream',
    'DISPID_SRRSaveToMemory', 'SpTextSelectionInformation',
    'SpeechGrammarTagWildcard', 'ISpRecoGrammar2', 'SRAInterpreter',
    ...
    'DISPID_SABIMinNotification', 'DISPID_SVEPhoneme', 'SVP_11',
    'SPSHT_EMAIL', 'DISPID_SDKEnumValues', 'SVSFParseMask',
    'ISpeechAudioFormat', 'SVPOver', 'SPPS_RESERVED1',
    'SVSFParseSapi', 'SPFILEMODE', 'DISPID_SOTs_NewEnum',
    'DISPID_SRRGetXMLErrorInfo', 'SRERecognition',
    'ISpeechRecognizer', 'SPRST_ACTIVE_ALWAYS', 'SPDKL_CurrentUser',
    'SPEI_START_SR_STREAM', 'DISPID_SPPNumberOfElements', 'ISpVoice',
    'ISpShortcut', 'SVSFIsXML', 'SSTTDictation',
    'SPEI_END_INPUT_STREAM', 'ISpeechGrammarRule', 'SPRS_ACTIVE',
    'SAFT8kHz8BitStereo', 'SAFTText', 'DISPID_SpeechXMLRecoResult',
    'SRSEIsSpeaking', 'DISPID_SGRsCommitAndSave', 'SPVPRI_NORMAL',
    'SPVISEMES', 'DISPID_SRRSpeakAudio', 'DISPID_SRGetRecognizers',
    'DISPID_SVGetProfiles', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SRRGetXMLResult', 'SRATopLevel',
    'DISPID_SPIEnginePrivateData', 'SPXRO_SML',
    'DISPID_SRGIsPronounceable', 'ISpeechGrammarRules',
    'SAFT8kHz16BitMono', 'DISPID_SABufferInfo', 'SRAORetainAudio',
    'DISPID_SVDisplayUI', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SCSBaseStream', 'SVSFPurgeBeforeSpeak', 'SVP_16',
    'SAFTGSM610_8kHzMono', 'SVP_9', 'SPVPRI_OVER', 'DISPID_SRCState',
    'SPEI_RESERVED2', 'SRARoot', 'SAFTCCITT_ALaw_22kHzMono',
    'eLEXTYPE_PRIVATE11', 'SPAS_RUN', 'ISpeechPhraseProperties',
    'SPWT_DISPLAY', 'SVP_18', 'SpeechCategoryAppLexicons',
    'DISPID_SRRRecoContext', '_SPAUDIOSTATE', 'SPAO_NONE',
    'DISPID_SRGCommit', 'DISPID_SWFEFormatTag',
    ...
    'eLEXTYPE_PRIVATE8', 'SPCS_DISABLED', 'SAFT22kHz8BitMono',
    'SPEI_RESERVED3', 'SP_VISEME_12', 'DISPID_SpeechLexiconWord',
    ...
    'DISPID_SRCRetainedAudio', 'DISPID_SRCEAdaptation', 'SINone',
    'ISpeechVoice', 'SDKLCurrentUser', 'SAFTNonStandardFormat',
    'SVP_8', 'SAFT16kHz16BitStereo', 'ISpeechFileStream',
    'SpeechVoiceEvents', 'SBOPause', 'SpeechRecoContextState',
    'SAFT16kHz16BitMono', 'DISPID_SpeechLexiconPronunciation',
    'SGRSTTWildcard', 'DISPID_SGRSTPropertyName', 'SDTReplacement',
    'DISPID_SRSNumberOfActiveRules', 'SPEI_PROPERTY_NUM_CHANGE',
    'SRCS_Disabled', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SASFreeBufferSpace', 'SP_VISEME_13',
    'SpeechTokenKeyFiles', 'DISPID_SVSkip', 'eLEXTYPE_RESERVED6',
    'DISPID_SLPPhoneIds', 'SDTDisplayText', 'ISpeechLexicon',
    'DISPID_SPEEngineConfidence', 'SP_VISEME_5', 'DISPID_SGRId',
    'DISPIDSPTSI', 'DISPID_SPACommit', 'IInternetSecurityMgrSite',
    'DISPID_SRRPhraseInfo', 'IEnumSpObjectTokens', 'SP_VISEME_14',
    'eLEXTYPE_PRIVATE17', 'SpeechGrammarState', 'ISpRecoContext2',
    'SPLOADOPTIONS', 'SpMMAudioOut', 'DISPID_SPAs_NewEnum',
    'SREHypothesis', 'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SBSFormat',
    'DISPID_SVEVoiceChange', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SMSSetData', 'DISPID_SPCPhoneToId',
    'SPEI_SR_RETAINEDAUDIO', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRGCmdSetRuleIdState', 'SpeechSpecialTransitionType',
    'SVP_0', 'ISpeechGrammarRuleStateTransition', 'SPPARTOFSPEECH',
    'SGRSTTTextBuffer', 'DISPID_SRCERequestUI', 'DISPID_SRGReset',
    ...
    'DISPID_SRRSetTextFeedback', 'DISPID_SPILanguageId', 'SREPrivate',
    'DISPID_SpeechBaseStream', 'SpeechWordType',
    'SGDSActiveUserDelimited', 'DISPID_SPEAudioSizeBytes',
    'SpeechVoiceCategoryTTSRate', 'SpStream', 'SAFTADPCM_22kHzStereo',
    'SP_VISEME_17', 'SpeechLexiconType', 'ISpeechGrammarRuleState',
    'SPBOOKMARKOPTIONS', 'ISpeechAudio', 'DISPID_SDKCreateKey',
    'SREStateChange', 'DISPID_SPPFirstElement', 'DISPID_SOTCSetId',
    'SGSEnabled', 'SPEI_SR_PRIVATE', 'SPAO_RETAIN_AUDIO',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPPS_Noncontent',
    'SpMemoryStream', 'SREPropertyNumChange', 'SpeechLoadOption',
    'SAFTDefault', 'SpeechAudioFormatGUIDText', 'SVP_2',
    'DISPID_SABIBufferSize', 'SAFT24kHz8BitStereo',
    'SPRST_NUM_STATES', 'DISPID_SOTId', 'DISPID_SVRate', 'SSFMCreate',
    'DISPID_SDKGetStringValue', 'ISpProperties', 'DISPID_SVEBookmark',
    'DISPID_SRCPause', 'SRADefaultToActive', 'ISpGrammarBuilder',
    'SAFT44kHz8BitStereo', 'SRSInactive', 'DISPID_SRAudioInputStream',
    'SPFM_CREATE_ALWAYS', 'SVEViseme', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SGRSTWeight', 'SpPhoneticAlphabetConverter',
    'SpeechCategoryAudioIn', 'DISPID_SPIProperties',
    'ISpNotifyTranslator', 'SPEI_HYPOTHESIS', 'DISPID_SPEsCount',
    'SPBO_PAUSE', 'DISPID_SPRNumberOfElements',
    ...
    'SPINTERFERENCE_NONE', 'SPPHRASERULE', 'SpeechRuleState',
    'SVP_12', 'SpeechStreamSeekPositionType', 'SITooSlow',
    'DISPID_SPRuleNumberOfElements', 'STSF_CommonAppData',
    'ISpSerializeState', 'DISPID_SRCEEndStream', 'SPEI_VISEME',
    'SPRECOSTATE', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SVSLastBookmarkId', 'SPEI_RESERVED6', 'DISPID_SLWsCount',
    'SSFMOpenReadWrite', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SRCCmdMaxAlternates', 'SREBookmark', 'DISPID_SPPParent',
    'eWORDTYPE_DELETED', 'SpeechPropertyNormalConfidenceThreshold',
    'SpeechVisemeType', 'DISPID_SpeechPhraseProperties',
    'DISPID_SVSInputSentencePosition', 'DISPID_SpeechLexiconWords',
    'eLEXTYPE_RESERVED4', 'DISPID_SADefaultFormat',
    'eLEXTYPE_PRIVATE5', 'DISPID_SpeechCustomStream', 'SLODynamic',
    'DISPID_SRCBookmark', 'DISPID_SRGState', 'SAFT16kHz8BitStereo',
    'ISpeechPhraseReplacement', 'DISPID_SpeechRecognizer',
    'SPWORDTYPE', 'SPINTERFERENCE', 'DISPID_SPEs_NewEnum',
    'DISPID_SRCResume', 'ISpeechRecoResult', 'DISPID_SWFEExtraData',
    'SPCS_ENABLED', 'SVP_1', 'DISPID_SGRsFindRule',
    '_RemotableHandle', 'SLOStatic', 'SPGRAMMARWORDTYPE',
    'DISPID_SpeechAudio', 'DISPID_SRIsUISupported', 'IStream',
    ...
    'ISpeechLexiconPronunciation', 'SPAUDIOOPTIONS', 'SP_VISEME_0',
    'SPWAVEFORMATTYPE', 'DISPID_SPPsCount', 'DISPID_SPPValue',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVSLastResult',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPRuleFirstElement',
    'DISPID_SGRAttributes', 'SpeechBookmarkOptions', 'STCAll',
    'DISPID_SpeechGrammarRules', 'SPWT_LEXICAL',
    'DISPID_SpeechPhraseElement',
    'SpeechGrammarTagUnlimitedDictation', 'SGRSTTDictation',
    'SGDSActive', 'DISPID_SOTCEnumerateTokens', 'SVEPhoneme',
    'SPSFunction', 'SPEI_SOUND_END', 'SpeechPropertyAdaptationOn',
    'SRSActive', 'ISpeechLexiconWord', 'DISPID_SOTCId',
    'ISpeechPhraseInfo', 'SpeechTokenShellFolder',
    'SGLexicalNoSpecialChars', 'DISPID_SRRAlternates',
    'DISPID_SPIElements', 'SpeechEmulationCompareFlags',
    'DISPID_SBSWrite', 'DISPID_SPPId', 'SVPNormal', 'SREAllEvents',
    'DISPID_SPEDisplayAttributes', 'ISpeechResourceLoader',
    'DISPID_SPISaveToMemory', 'SVEWordBoundary',
    'DISPID_SRCEventInterests', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SPIReplacements', 'SITooFast', 'SpeechInterference',
    'SpeechFormatType', 'ISpStreamFormatConverter',
    'SAFT24kHz16BitStereo', 'ISpeechVoiceStatus', 'SPRS_INACTIVE',
    'SpObjectToken', 'eLEXTYPE_PRIVATE1', 'DISPID_SWFEBlockAlign',
    'DISPID_SREmulateRecognition',
    'ISpeechGrammarRuleStateTransitions', 'SINoSignal', 'ISpLexicon',
    'DISPID_SWFEBitsPerSample', 'DISPID_SGRSTNextState',
    'IEnumString', 'SP_VISEME_8', 'SPEI_VOICE_CHANGE',
    'ISpeechPhraseElement', '__MIDL_IWinTypes_0009',
    'SDA_No_Trailing_Space', 'SGLexical', 'DISPID_SRSAudioStatus',
    'SPRST_ACTIVE', 'SGSExclusive', 'SPPHRASEELEMENT',
    'ISpRecoResult', 'SpeechAudioProperties',
    'DISPID_SGRSTPropertyId', 'ISpPhrase',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SLPsItem',
    'DISPID_SDKSetLongValue',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SPINTERFERENCE_TOOSLOW', 'SpeechRuleAttributes',
    'DISPID_SRProfile', 'DISPID_SWFESamplesPerSec', 'SPGS_ENABLED',
    'DISPID_SOTsCount', 'SRAONone', 'SPPHRASEREPLACEMENT',
    'SVSFParseSsml', 'DISPID_SVGetAudioInputs', 'SRSEDone',
    'SpeechRunState', 'SPCT_SUB_DICTATION', 'ISpPhoneConverter',
    'ISpPhoneticAlphabetSelection', 'SPSHORTCUTTYPE',
    'SPWORDPRONOUNCEABLE', 'SPSHORTCUTPAIRLIST', 'DISPID_SGRSTText',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPRuleChildren',
    'DISPID_SLGenerationId', 'eLEXTYPE_APP',
    'DISPID_SpeechPhraseRules', 'DISPID_SVResume',
    'ISpeechPhraseRules', 'DISPID_SpeechMemoryStream',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpeechLexiconPronunciations', 'DISPID_SVESentenceBoundary',
    'ISpeechRecoGrammar', 'DISPID_SAFSetWaveFormatEx',
    'SPRECOGNIZERSTATUS', 'SPBO_TIME_UNITS', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRRTimes', 'SP_VISEME_18',
    'DISPID_SRGetPropertyNumber', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRState', 'SDTLexicalForm', 'DISPID_SGRSRule',
    'SPEI_END_SR_STREAM', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SLWsItem', 'DISPID_SpeechPhraseRule',
    'DISPID_SPANumberOfElementsInResult', 'SPVPRIORITY',
    'SP_VISEME_11', 'SpeechDisplayAttributes', 'SP_VISEME_10',
    'DISPID_SRCSetAdaptationData', 'SPPS_RESERVED2',
    ...
    'DISPID_SLGetGenerationChange', 'SpNullPhoneConverter',
    'DISPID_SDKSetBinaryValue', 'SAFT32kHz8BitStereo',
    'DISPID_SRGCmdLoadFromObject', 'SPAR_Low', 'SINoise',
    'SWPUnknownWordUnpronounceable', '_ISpeechRecoContextEvents',
    'ISpeechWaveFormatEx', 'DISPID_SMSADeviceId',
    'SAFTCCITT_uLaw_11kHzMono', 'SVP_6', 'SpPhraseInfoBuilder',
    'DISPID_SPIRule', 'SVF_None', 'DISPID_SLPSymbolic',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVEAudioLevel',
    'ISpeechRecognizerStatus', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPLO_STATIC', 'SAFTADPCM_44kHzMono', 'SPEI_INTERFERENCE',
    'SPCT_DICTATION', 'SPINTERFERENCE_TOOFAST', 'DISPID_SVSPhonemeId',
    'DISPID_SpeechRecoResult', 'SpMMAudioEnum', 'SpFileStream',
    'eLEXTYPE_VENDORLEXICON', 'eLEXTYPE_RESERVED8',
    'DISPID_SGRSTRule', 'SpSharedRecognizer', 'SPFM_OPEN_READONLY',
    'DISPID_SVVoice', 'DISPID_SpeechVoice',
    'DISPID_SPRDisplayAttributes', 'ISpeechObjectTokens',
    'DISPID_SRGSetTextSelection', 'SPSHT_Unknown',
    'SpUnCompressedLexicon', 'DISPID_SDKOpenKey',
    'SAFTNoAssignedFormat', 'SpeechMicTraining',
    'SpeechTokenKeyAttributes', 'SpeechPropertyResponseSpeed',
    'DISPID_SGRsCommit', 'SVF_Stressed', 'SRCS_Enabled',
    'DISPID_SVAlertBoundary', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SAFType',
    'SPCT_SUB_COMMAND', 'SVEAllEvents', 'DISPID_SGRAddResource',
    'DISPID_SASState', 'SpInProcRecoContext', 'SRADynamic',
    ...
    'DISPID_SVSCurrentStreamNumber', 'SPPS_SuppressWord',
    'SSFMOpenForRead', 'DISPID_SpeechGrammarRule',
    'DISPID_SPARecoResult', 'ISpeechLexiconWords', 'DISPID_SPAsItem',
    'DISPID_SRCERecognition', 'DISPID_SPELexicalForm', 'SPPS_LMA',
    'SPWORD', 'DISPID_SRStatus', 'SVSFNLPSpeakPunc',
    'SpeechAudioFormatType', 'SpeechPropertyComplexResponseSpeed',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_PRIVATE3',
    'DISPID_SRRTLength', 'DISPID_SLPType', 'SAFTADPCM_8kHzMono',
    'SGDSInactive', 'DISPID_SBSRead', 'SpeechAllElements',
    'SPAS_STOP', 'DISPID_SGRSAddSpecialTransition', 'SLTApp',
    'DISPID_SPIAudioStreamPosition', 'SAFT16kHz8BitMono',
    'DISPID_SVGetVoices', 'SDA_Consume_Leading_Spaces',
    'DISPID_SGRAddState', 'DISPID_SRGSetWordSequenceData',
    'SP_VISEME_20', 'SRTEmulated', 'DISPID_SpeechPhraseReplacements',
    'SpeechDictationTopicSpelling', 'SAFTCCITT_ALaw_44kHzMono',
    'SGRSTTWord', 'ISpObjectWithToken', 'DISPID_SRCESoundStart',
    'SPPHRASEPROPERTY', 'SP_VISEME_21', 'SAFT44kHz16BitMono',
    'SPVPRI_ALERT', 'SECFNoSpecialChars', 'SAFT8kHz8BitMono',
    'DISPID_SPRsItem', 'SVSFDefault', 'DISPID_SGRSTPropertyValue',
    'SPSERIALIZEDPHRASE', 'SWPUnknownWordPronounceable',
    'SPLO_DYNAMIC', 'DISPID_SPRsCount', 'SpeechAudioFormatGUIDWave',
    'SPSSuppressWord', 'ISpeechMemoryStream', 'SECFDefault',
    ...
    'SpeechTokenIdUserLexicon', 'SPPHRASE', 'SPEI_RESERVED5',
    'SGDSActiveWithAutoPause', 'eLEXTYPE_PRIVATE2',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRCRetainedAudioFormat', 'SPEI_RESERVED1',
    'ISpEventSource', 'ISpeechPhraseAlternate', 'SVP_14',
    'SpeechGrammarTagDictation', 'eLEXTYPE_PRIVATE14',
    'SAFT32kHz16BitMono', 'SVP_10', 'SPGS_DISABLED',
    'SpeechTokenKeyUI', 'SpeechStreamFileMode',
    'SpeechRecoProfileProperties', 'DISPID_SPPName',
    'STSF_FlagCreate', 'SRTAutopause', 'ISpStream',
    'DISPID_SpeechVoiceStatus', 'SPEVENTENUM',
    'DISPID_SRCEEnginePrivate', 'DISPID_SRCEPhraseStart',
    'SRERecoOtherContext', 'DISPID_SGRsDynamic', 'eLEXTYPE_RESERVED9',
    'SDKLLocalMachine', 'SVESentenceBoundary',
    'DISPID_SLAddPronunciation', 'SRTSMLTimeout',
    'DISPID_SRSetPropertyString', 'DISPID_SPEAudioTimeOffset',
    'SVP_3', 'DISPID_SMSAMMHandle', 'SpResourceManager',
    'DISPID_SOTGetDescription', 'SAFT44kHz8BitMono',
    'DISPID_SpeechPhraseProperty', 'LONG_PTR',
    'DISPID_SOTGetStorageFileName', 'ISpObjectToken', 'SGSDisabled',
    'SAFT24kHz8BitMono', 'SPWORDPRONUNCIATION', 'SPEI_SOUND_START',
    'DISPID_SLPs_NewEnum', 'SpeechRecognizerState', 'SFTSREngine',
    'SpeechRecognitionType', 'SREStreamStart',
    'SpeechCategoryRecoProfiles', 'DISPID_SVEViseme', 'ISpRecognizer',
    'SAFT32kHz16BitStereo', 'DISPID_SRCVoice',
    'DISPID_SpeechRecoContext', 'DISPID_SPRuleId',
    'DISPID_SPPs_NewEnum', 'ISpeechDataKey',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SDKDeleteValue',
    'DISPID_SpeechObjectTokenCategory', 'SPSNoun', 'DISPID_SAVolume',
    'SAFT48kHz8BitMono', 'SITooQuiet', 'SRSInactiveWithPurge',
    'SP_VISEME_1', 'SPSHORTCUTPAIR', 'DISPID_SDKSetStringValue',
    'SVF_Emphasis', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SOTCategory', 'SRESoundStart', 'SDTPronunciation',
    'SAFT24kHz16BitMono', 'STSF_LocalAppData',
    'DISPID_SASNonBlockingIO', 'SRSActiveAlways', 'ISpRecoContext',
    ...
    'Speech_Default_Weight', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT12kHz16BitMono', 'SPEI_RECO_STATE_CHANGE', 'SPCT_COMMAND',
    'SpCustomStream', 'DISPID_SPIGrammarId', 'DISPID_SPPChildren',
    'SPXRO_Alternates_SML', 'DISPID_SGRSAddWordTransition',
    'SREPhraseStart', 'SPSHT_NotOverriden',
    'DISPID_SPIAudioSizeBytes', 'SRAExport',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPPS_Function', 'DISPIDSPRG', 'STCLocalServer',
    'SpCompressedLexicon', 'DISPID_SOTCreateInstance', 'SPSVerb',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRCRequestedUIType',
    'DISPID_SPIGetText', 'DISPID_SVEventInterests',
    'SECFIgnoreKanaType', 'DISPID_SOTSetId', 'SpeechGrammarWordType',
    'DISPID_SLWLangId', 'DISPID_SRCEAudioLevel', 'eLEXTYPE_PRIVATE18',
    'DISPID_SABufferNotifySize', 'DISPID_SRGDictationLoad',
    'ISpNotifySink', 'DISPID_SRGDictationSetState',
    'DISPID_SpeechDataKey', 'SPAS_CLOSED', 'SPEVENT',
    'SpeechWordPronounceable', 'ISpeechPhraseInfoBuilder',
    'tagSPTEXTSELECTIONINFO', 'SPTEXTSELECTIONINFO',
    'SpeechAddRemoveWord', 'DISPID_SAEventHandle',
    'SAFTCCITT_ALaw_8kHzMono', 'SDTAll', 'DISPID_SPEDisplayText',
    'DISPID_SVGetAudioOutputs', 'SPAUDIOSTATUS', 'SP_VISEME_16',
    'SREFalseRecognition', 'SAFT22kHz16BitStereo',
    'DISPID_SRGCmdSetRuleState', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRSClsidEngine', 'DISPID_SpeechAudioStatus',
    'ISpeechAudioBufferInfo', 'DISPID_SLPPartOfSpeech', 'SPSMF_UPS',
    'SPPS_Noun', 'DISPID_SVSpeak', 'DISPID_SPIStartTime',
    'SPGS_EXCLUSIVE', 'SPFM_OPEN_READWRITE', 'ISpAudio',
    'SAFT12kHz8BitMono', 'SGPronounciation',
    'DISPID_SPIGetDisplayAttributes', 'SVSFNLPMask',
    'DISPID_SDKGetlongValue', 'DISPID_SASCurrentDevicePosition',
    'SASRun', 'SSSPTRelativeToStart', 'SpeechCategoryRecognizers',
    'SASStop', 'DISPID_SAStatus', 'DISPID_SAFGetWaveFormatEx',
    'SAFT44kHz16BitStereo', 'eLEXTYPE_USER_SHORTCUT',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SpeechMMSysAudio',
    'SpStreamFormatConverter', 'eLEXTYPE_PRIVATE20',
    'SVEEndInputStream', 'DISPID_SVEWord', 'SVEVoiceChange',
    'SP_VISEME_4', 'SDTProperty', '_ISpeechVoiceEvents',
    'DISPID_SRCEHypothesis', 'SWPKnownWordPronounceable',
    'DISPID_SLWPronunciations', 'SPEI_PHRASE_START',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SPPsItem'
]

_check_version('1.2.0', 1696967438.465253)
